...
import bomond.cryptolist.resource.R

class CustomStrokeTextView : AppCompatTextView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        if (attrs != null) {
            val a = context.obtainStyledAttributes(attrs, R.styleable.CustomStrokeTextView)
            outlineColor = a.getColor(R.styleable.CustomStrokeTextView_outlineColor, currentTextColor)
            outlineWidth = a.getDimension(R.styleable.CustomStrokeTextView_outlineWidth, defaultOutlineWidth)
